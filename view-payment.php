...
<body class="bg-dark">
    <main>
        <article>
            <section>
                <a href="order-summary.php?order_number=<?php echo $_GET['order_number']?> " title="Back" class="text-white">
        ...
        <article>
            <section>
                <?php
                    ...
                    $paymentPhoto="";
                    $getPaymentPhoto = $connect->prepare("SELECT payment_photo FROM tblcustomerorder WHERE order_number=?");
