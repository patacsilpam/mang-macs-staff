...
<body>
    <div class="grid-container">
        ...
        <header class="nav-container">
            <h3 class="mx-2 font-weight-normal">Create Add-On</h3>
            <ul class="nav-list">
                ...
                <article>
                    <div class="table-responsive table-container">
                        <div class="add-product">
                            ...
                            <?php include 'assets/template/addOns.php'?>
                        </div> <br>
                                    ...
                                    while($getProductCategory->fetch()){
                                        ...
                                        <tr>
                                            ...
                                            <td style="display:flex;">
                                                ...
                                                </button><?php include 'assets/template/addOns.php'; ?> &nbsp;
    ...
    <script src="assets/js/create-add-on.js"></script>
</body>
