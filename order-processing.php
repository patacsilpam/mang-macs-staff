...
<head>
    ...
    <title>Order (Order Processing)</title>
</head>
...
<body>
    <div class="grid-container">
        ...
        <header class="nav-container">
            <h3 class="mx-2 font-weight-normal">Order <small>(Order Processing)</small></h3>
            <ul class="nav-list">
                    ...
                    <div class="table-responsive table-container">
                        <table id="example" class="table table-hover">
                            ...
                            <?php
                                    ...
                                    //fetch new orders with "Order Processing" status from table `tblorderdetails` with join table `tblcustomerorder`
                                    ...
                                    WHERE tblorderdetails.order_status = 'Order Processing'  GROUP BY tblorderdetails.order_number 
