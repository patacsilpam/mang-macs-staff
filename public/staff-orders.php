            ...
            if($orderType == "Pick Up"){
                if($orderStatus == "Pending"){
                    ...
                    if($OrderStatus){
                        ...
                        $mail->Body=" <div style='background:#ffffff; border:15px solid #36E49A; font-family:arial; position:relative;  width:450px;   margin:0 auto;  padding:20px;'>
                        <div style='padding:5px; text-align:center;'>
                           <div style='background:#000;  color:#fff;   font-size:2rem; width:70px; height:70px; border-radius:50%; margin:auto;'>
                                <p><span style='line-height:65px;'>$firstLetter</span></p>
                            </div>
                            <div>
                                <p>$customerName</p>
                            </div>
                        ...
                        <p style='color:#6F6F6F; font-size:12px; text-align:center;'>$completedTime</p>
                        <hr>
                        <div style='color:#6F6F6F; margin:20px 0;'>
                            ...
                            <div>
                                ...
                                <span style='float:right;'>PHP $totalAmount .00</span>
                            </div>
                        </div>
                        <hr>
                        <div>
                    ...
                    if($OrderStatus){
                        ...
                        <div style='display: flex; flex-direction: column; align-items: center;'>
                            ...
                            <div style='text-align: center;'>
                                ...
                                <!---Display customer name here using php-->
                                <p>Hello ".$customerName."</p>
                                <p style='text-align:justify;''> Your order ".$orderNumber."  is now being processed.</p>
                            </div>
                            </div>
                            <hr style='border:0.3px solid #dbdbdb;'>
                            <div>
                    ...
                    if($OrderStatus){
                        function pushNotifcation($sendTo,$data){
                            ...
                            pushNotifcation($sendTo,$data);
                            $mail->Subject = "Your Order #".$orderNumber." is already completed.";
                        $mail->Body = "
                        <div class='container' style='padding: 1rem;'>
                        <div style='display: flex; flex-direction: column; align-items: center;'>
                            <div class='logo-section'>
                            ...
                            <div style='text-align: center;'>
                                ...
                                <!---Display customer name here using php-->
                                <p>Hello ".$customerName."</p>
                                <p style='text-align:justify;''> Your order ".$orderNumber." has been delivered.</p>
                            </div>
                            </div>
                            <hr style='border:0.3px solid #dbdbdb;'>
                            <div>
                        ...
                        if($OrderStatus){
                            ...
                            <div style='display: flex; flex-direction: column; align-items: center;'>
                                ...
                                <div style='text-align: center;'>
                                    ...
                                    <!---Display customer name here using php-->
                                    <p>Hello ".$customerName."</p>
                                    <p style='text-align:justify;''>Your Order #".$orderNumber." is out for delivery.</p>
                                </div>
                            </div>
                            <hr style='border:0.3px solid #dbdbdb;'>
                            <div>
