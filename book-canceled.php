...
<body>
    <div class="grid-container">
        ...
        <header class="nav-container">
            <h3 class="mx-2 font-weight-normal">Reservation <small>(Canceled)</small></h3>
            <ul class="nav-list">
                        ...
                        <table id="example" class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    //fetch 'Cancelled' and 'No Shows' from table `tblreservation`
                                    $queryReservation = $connect->query("SELECT * FROM tblreservation 
                                    WHERE status IN ('Cancelled','No Shows')
